...
in
{
  ...
  home.file.".config/kak-tree-sitter/config.toml".source =
    tomlFormat.generate "config.toml" (import ./kts-config.nix);
  ...
  home.file.".config/kak/colors/custom.kak".text = with config.stylix.base16Scheme; ''
    declare-option str base00 'rgb:${base00}'
    declare-option str base01 'rgb:${base01}'
    declare-option str base02 'rgb:${base02}'
    declare-option str base03 'rgb:${base03}'
    declare-option str base04 'rgb:${base04}'
    declare-option str base05 'rgb:${base05}'
    declare-option str base06 'rgb:${base06}'
    declare-option str base07 'rgb:${base07}'
    declare-option str base08 'rgb:${base08}'
    declare-option str base09 'rgb:${base09}'
    declare-option str base0A 'rgb:${base0A}'
    declare-option str base0B 'rgb:${base0B}'
    declare-option str base0C 'rgb:${base0C}'
    declare-option str base0D 'rgb:${base0D}'
    declare-option str base0E 'rgb:${base0E}'
    declare-option str base0F 'rgb:${base0F}'
